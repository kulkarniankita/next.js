...
> **Good to know**: The example above uses the common [`__tests__`](https://jestjs.io/docs/configuration#testmatch-arraystring) convention, but test files can also be colocated inside the `app` router.
